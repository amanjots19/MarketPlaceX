...
exports.postSignup = (req, res, next) => {
  ...
  if(!errors.isEmpty){
    ...
    .then((result) => {
      ...
      //   to:email,
      //   frome:'shop@node-complete.com',
      //   subject:'signup succesful',
      //   html:'<h1>You have succcesfully signed up </h1>'
  ...
  crypto.randomBytes(32, (err , buffer)=>{
    ...
    User.findOne({email:req.body.email}).then(user=>{
      ...
      return transport.sendMail({
          ...
          <p> Click the linl <a href="https://localhost:3000/reset/${token}"></a> to reset the password.<p>`
...
exports.postNewPassword=(req,res,next)=>{
  const newPassword= req.body.params;
